        ...
        <div className="register">
            <div className="register__container">
                ...
                <form className="register__form">
                    ...
                    <input name="name" type="text" className="register__input" placeholder="Name" minLength={2} maxLength={30} required />
                    ...
                    <input name="password" type="password" className="register__input" placeholder="Password" minLength={8} required />
